...
const BLOG = {
  ...
  THEME: process.env.NEXT_PUBLIC_THEME || 'yamedium', // 当前主题，在themes文件夹下可找到所有支持的主题；主题名称就是文件夹名，例如 example,fukasawa,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'hanff8', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '听凭风引～～', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://hanff.vercel.app', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'hanffeix@outlook.com', // 邮箱地址 例如mail@tangly1024.com
